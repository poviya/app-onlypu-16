...
import { Post, Bookmark, User } from 'src/app/interfaces';
...
@Component({
  selector: 'app-post-ad-modal',
  templateUrl: './post-ad-modal.component.html',
  styleUrls: ['./post-ad-modal.component.scss'],
  animations: [
    trigger('animation', [
...
export class PostAdModalComponent implements OnInit {
