...
import { PostAdService, TipService, } from 'src/app/services';
...
import { Cam, Post } from 'src/app/interfaces';
...
export class ListComponent implements OnInit {
  ...
  postLoading: string[] = ["hola", "que", "tal",  "tal"];
  ...
  onCam(item: Cam): void {
    ...
    { queryParams: { roomID: item.User!.Cam!.roomId } });
  }
}
